...
static const float focuscolor[]            = COLOR(0xeba0acff);
...
static const char *clipmenucmd[] = {
	"zsh", "-c",
	"cliphist list | wmenu-color -l 10 | cliphist decode | wl-copy",
	NULL
};
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_semicolon,  spawn,            {.v = clipmenucmd} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_M,          spawn,            SHCMD("mpdmenu -a") },
